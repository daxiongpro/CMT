...
class_names = [
    ...
    'tricycle', 'construction_vehicle', 'other'
]
data_config = {
...
root_path = '/cpfs/user/zhengyi/code/CMT/'
dataset_type = 'MegviiDataset'
data_root = root_path + 'data/megvii_data/new_custom_data/'
input_modality = dict(
    use_lidar=True,
    use_camera=True,
    use_radar=False,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'megvii_infos_train.pkl',
            load_interval=1,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'megvii_infos_val.pkl',
        load_interval=1,
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'megvii_infos_test.pkl',
        load_interval=1,
        pipeline=test_pipeline,
        class_names=class_names,
        modality=input_modality,
